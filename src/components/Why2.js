...
const Why2 = () => {
  ...
  return (
    <div className="why2 poppins-medium" id="why2">
      {/*
      ...
      */}
      <div className='why2-carrusel-importado'>
        <CarruselWhy />
      </div>
      <div className='why2-contenedor-imagenes'></div>

      <div className='why2-contenedor'>

        <div className="carousel2">
            <Carousel data-bs-theme="dark" interval={6000}>
                <Carousel.Item>
                    <div className='why2-header por-que'><h1>¿POR QUÉ ARRENDAR?</h1></div>
                    <div className='why2-info'>
                        <ul>
                            <li>
                ...
                <Carousel.Item>
                    <div className='why2-header que'><h1>¿QUÉ ARRENDAMOS?</h1></div>
                    <div className='why2-textos-informacion'>
                    <ul>
                        <li>
                        ...
                        <Modal show={show} onHide={handleClose} centered fullscreen={true} animation={true}>
                            ...
                            <Modal.Body>
                                ...
                                <FichaTecnica2></FichaTecnica2>
                            </Modal.Body>
                            <Modal.Footer className="modal-footer-left">
