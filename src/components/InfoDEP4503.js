...
//import radio_dep from '../img/rsz_radio-dep450.png'
import radio_dep from '../img/rsz_radio-dep450.webp'
    ...
    <div>
        <div className='ficha-tecnica3'>
            ...
            <div className='c-izquierda'>
                <img className="img-fluid" src={radio_dep} width="88%"/>
            </div>
            */}
            <div className='c-derecha'>
                ...
                <div className='titulos'>
                    <img className="img-fluid img-radiodep" src={radio_dep} width="30%" alt="Radio motorola dep450 grande"/>
                ...
                <div className='contenedor-textos'>
                    <div className='texto-izquierda'>
                        ...
                        <h4 className='texto-introduccion3'>
