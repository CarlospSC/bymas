...
const Whatsapp3 = () => {
  ...
  useEffect(() => {
    function handleScroll() {
      if (window.scrollY > 100) { // Cambia 200 por la distancia que desees
        setShowLogo(true);
      } else {
        setShowLogo(false);
      }
  ...
  return (
    <div id="container">
      {showLogo && 
        <div id="whatsapp">
          <a href="https://api.whatsapp.com/send?phone=56930576898&text=Hola!,%20tengo%20una%20consulta..." target="_blank">
            <svg width="60" height="60" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
              <g class="layer">
                <circle cx="40" cy="40" fill="#fff" id="svg_1" r="23"       stroke="#000000" stroke-width="0"/>
