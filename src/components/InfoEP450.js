...
//import radio_ep from '../img/radio-ep450-4.png'
import radio_ep from '../img/radio-ep450-4.webp'
    ...
    <div>
      <div className='ficha-tecnica'>
            <div className='c-izquierda'>   
                <img className="img-fluid" src={radio_ep} width="80%" alt="Radio motorola ep grande"/>
            </div>
        ...
        <div className='texto-en-celeste'>
